...
def setupInputs(expInfo, thisExp, win):
    ...
    # Serial Port 
    inpout = io.launchHubServer()
    serial_port = inpout.devices.serial.Serial()
    serial_port.initialize(name='COM1', baud=9600, timeout=0.1)
...
def ImageListCreator(paradigm, degree, BG_color, img_dir, exl_dir):
    ...
    df.to_excel(op.join(exl_dir, 'loopTemplate18.xlsx'), index=False)