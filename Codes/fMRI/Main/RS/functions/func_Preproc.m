...
delete(fullfile(datapath, 'mean*.*'));
delete(fullfile(datapath, 'wmean*.*'));
delete(fullfile(datapath, 'swmean*.*'));
delete(fullfile(datapath, '*.mat'));
delete(fullfile(datapath, 'msc*.*'));
delete(fullfile(datapath, 'wmsc*.*'))
movefile(fullfile(datapath, 'swmsc*.nii'), motionCorrectedDir);
movefile(fullfile(datapath, 'swmsc*.par'), motionCorrectedDir);
...
delete(fullfile(datapath, 'mwp1*.*'));
delete(fullfile(datapath, 'mwp2*.*'));
delete(fullfile(datapath, 'mwp3*.*'));
