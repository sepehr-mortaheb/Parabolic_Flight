function [matlabbatch, art_pth] = func_ArtDetection_batch(motionCorrectedDir, save_path, subj_name, TR, ses)

matlabbatch = [];
dataMotion = spm_select('FPList', motionCorrectedDir, ['^swmsc.*\.(img|nii)$']);
